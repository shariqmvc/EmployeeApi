...
import com.apitest.model.ExceptionResponse;
...
@ControllerAdvice
public class ApiTestEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleSmartAutoSafeException(ApiTestException ex, WebRequest request) throws Exception {
